                                ...
                                <tr>
                                            ...
                                            <div class="flex items-center gap-x-3">
                                                <div class="grow">
                                                    <span class="block text-sm text-gray-500 dark:text-neutral-500">
                                                        {{-- @php
                                                            $pickupDate = optional(
                                                                $item->detail->first()->pickupdetail->pickup ?? null,
                                                            )->pickup_date;
                                                        @endphp

                                                        {{ $pickupDate ? \Carbon\Carbon::parse($pickupDate)->format('d/m/Y') : 'Barang belum diambil' }}</span> --}}
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            ...
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">
                                                @forelse ( $item->pickupdetail as $od )
                                                    {{ $loop->iteration }} {{ $od->orderdetail->description }}
                                                @empty
                                                'tidak ada data'
                                                @endforelse
                                                {{-- {{ $item }} --}}
