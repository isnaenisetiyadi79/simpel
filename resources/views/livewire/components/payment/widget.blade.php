  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                  ...
                  <div class="hs-tooltip">
                      <div class="hs-tooltip-toggle">
                          ...
                          <span
                              ...
                              role="tooltip">
                              Total Uang Masuk pada periode ini
                          </span>
                      </div>
                  </div>
              </div>
      ...
      <!-- Card -->
      <div
          class="flex flex-col border-l-2 border-green-500 shadow-sm rounded-xl cursor-pointer hover:shadow-md hover:bg-green-100 active:bg-green-300 dark:bg-neutral-800 dark:border-neutral-700 ">
          <div class="p-4 md:p-5">
              <div class="flex items-center gap-x-2">
                  <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
                      Sub Total
