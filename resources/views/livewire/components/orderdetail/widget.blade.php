  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-6">
      ...
      <div wire:click="setProcessStatus('process')"
          class="flex flex-col border-l-2 border-yellow-500 shadow-sm rounded-xl  cursor-pointer hover:shadow-md hover:bg-yellow-100 active:bg-yellow-300 dark:bg-neutral-800 dark:border-neutral-700 {{ $processStatus == 'process' ? 'bg-orange-200' : 'bg-white' }}">
          <div class="p-4 md:p-5">
              <div class="flex items-center gap-x-2">
                  <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
                      DiProses
