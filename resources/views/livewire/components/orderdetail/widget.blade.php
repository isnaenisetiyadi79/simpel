  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-6 gap-4 sm:gap-6">
      ...
      <!-- Card -->
      <div wire:click="setPendingStatus('pending')"
          class="flex flex-col border-l-2 border-orange-500 shadow-2xs rounded-xl dark:bg-neutral-800 dark:border-neutral-700 cursor-pointer hover:shadow-md hover:bg-orange-100 active:bg-orange-300 {{ $pendingStatus == 'pending' ? 'bg-orange-200' : 'bg-white' }}">
          <div class="p-4 md:p-5">
              ...
              <div class="flex items-center gap-x-2">
                  ...
                  <div class="hs-tooltip" {{ $pendingStatus != 'pending' ? 'hidden' : '' }}>
                      <div class="hs-tooltip-toggle">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                              <g fill="none">
                                  ...
                                  <path stroke="#191919" stroke-linecap="round" stroke-linejoin="round"
                                      ...
                                      stroke-width="1" />
                                  <path stroke="#191919" stroke-linecap="round" stroke-linejoin="round"
                                      d="m15.65 9.72l-3.714 4.95a.7.7 0 0 1-1.054.077l-2.228-2.23" stroke-width="1" />
                              </g>
                          </svg>
                          <span
                              class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded-md shadow-2xs dark:bg-neutral-700"
      ...
      <!-- Card -->
      <div wire:click="setProcessStatus('process')"
          class="flex flex-col border-l-2 border-blue-500 shadow-sm rounded-xl  cursor-pointer hover:shadow-md hover:bg-blue-100 active:bg-blue-300 dark:bg-neutral-800 dark:border-neutral-700 {{ $processStatus == 'process' ? 'bg-blue-200' : 'bg-white' }}">
          <div class="p-4 md:p-5">
              <div class="flex items-center gap-x-2">
                  <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
                      DiProses
                  </p>
                  <div class="hs-tooltip" {{ $processStatus != 'process' ? 'hidden' : '' }}>
                      <div class="hs-tooltip-toggle">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                              <g fill="none">
                                  <path fill="#ffef5e"
                          ...
                          <span
                              class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded-md shadow-2xs dark:bg-neutral-700"
                              role="tooltip">
                              Menampilkan pesanan yang sedang di proses
                          </span>
                      </div>
                  </div>
              </div>
      ...
      <!-- End Card -->
      <!-- Card -->
      <div wire:click="setDoneStatus('done')"
          class="flex flex-col border-l-2 border-green-500 shadow-sm rounded-xl cursor-pointer hover:shadow-md hover:bg-green-100 active:bg-green-300 dark:bg-neutral-800 dark:border-neutral-700 {{ $doneStatus == 'done' ? 'bg-green-200' : 'bg-white' }}">
          <div class="p-4 md:p-5">
              <div class="flex items-center gap-x-2">
                  <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
                      Selesai, belum diambil
                  </p>
                  <div class="hs-tooltip" {{ $doneStatus != 'done' ? 'hidden' : '' }}>
                      <div class="hs-tooltip-toggle">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                              <g fill="none">
                                  <path fill="#ffef5e"
                          ...
                          <span
                              class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded-md shadow-2xs dark:bg-neutral-700"
                              role="tooltip">
                              Menampilkan pesanan yang sudah selesai<br>
                              Tapi belum diambil
                          </span>
                      </div>
                  </div>
              ...
              <div class="flex justify-between mt-1">
                  <div class="flex items-center gap-x-2">
                      <h3 class="text-xl sm:text-2xl font-medium text-gray-800 dark:text-neutral-200">
                        {{ $orderdetail_notpickup_date->where('process_status', 'done')->count() }}
                      </h3>
                  </div>
