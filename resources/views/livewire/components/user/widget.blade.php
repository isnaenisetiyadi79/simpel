<!-- Grid -->
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-6">
        <!-- Card -->
        <div
            class="flex flex-col bg-white border-l-2 border-sky-500 shadow-lg  rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <!-- Card -->
        <div
            class="flex flex-col bg-white bg-white border-l-2 border-green-500 shadow-lg   rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="p-4 md:p-5">
                <div class="flex items-center gap-x-2">
                    <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
                        User Active
        ...
        <!-- Card -->
        <div
            class="flex flex-col bg-white border-l-2 border-red-500 shadow-lg rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="p-4 md:p-5">
                <div class="flex items-center gap-x-2">
                    <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
                        User Inactive
