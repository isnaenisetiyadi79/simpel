...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/isnaenisetiyadi/Documents/laravel/simpel/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/isnaenisetiyadi/Documents/laravel/simpel/public/storage','logging.default','logging.deprecations.channel',
...
'signed','throttle','verified','authenticate',);
        registerArgumentsSet('routes', 
'livewire.update','livewire.upload-file','livewire.preview-file','beranda','login.auth','dashboard','master.customer',
'master.customer.store','master.service','order','order.print','user',
'logout.auth','login','register','password.request','password.reset',
'verification.notice','verification.verify','password.confirm','logout','storage.local',);
        registerArgumentsSet('views', 
'auth.login','components.action-message','components.app-logo','components.app-logo-icon','components.auth-header',
...
'flux.navlist.group','layouts.header','layouts.master','layouts.sidebar','livewire.auth_aslinya(auth)doank.confirm-password',
'livewire.auth_aslinya(auth)doank.forgot-password','livewire.auth_aslinya(auth)doank.login','livewire.auth_aslinya(auth)doank.register','livewire.auth_aslinya(auth)doank.reset-password','livewire.auth_aslinya(auth)doank.verify-email',
'livewire.components.customers.modalform','livewire.components.customers.table','livewire.components.order.modalchange','livewire.components.order.modalform','livewire.components.order.table',
'livewire.components.order.widget','livewire.components.service.modalform','livewire.components.service.table','livewire.components.user.modalchange','livewire.components.user.modalform',
'livewire.components.user.table','livewire.components.user.widget','livewire.settings.appearance','livewire.settings.delete-user-form','livewire.settings.password',
'livewire.settings.profile','master.customer','master.service','order','partials.head',
'partials.settings-heading','printorder','user','volt-livewire::auth_aslinya(auth)doank.confirm-password','volt-livewire::auth_aslinya(auth)doank.forgot-password',
'volt-livewire::auth_aslinya(auth)doank.login','volt-livewire::auth_aslinya(auth)doank.register','volt-livewire::auth_aslinya(auth)doank.reset-password','volt-livewire::auth_aslinya(auth)doank.verify-email','volt-livewire::components.customers.modalform',
'volt-livewire::components.customers.table','volt-livewire::components.order.modalchange','volt-livewire::components.order.modalform','volt-livewire::components.order.table','volt-livewire::components.order.widget',
'volt-livewire::components.service.modalform','volt-livewire::components.service.table','volt-livewire::components.user.modalchange','volt-livewire::components.user.modalform','volt-livewire::components.user.table',
'volt-livewire::components.user.widget','volt-livewire::settings.appearance','volt-livewire::settings.delete-user-form','volt-livewire::settings.password','volt-livewire::settings.profile',
